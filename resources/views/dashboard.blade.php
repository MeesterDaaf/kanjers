...
@section('content')
            ...
            <div class="col-span-12 xl:col-span-9 xxl:col-span-9 z-10">
                ...
                <div class="mt-14 mb-3 grid grid-cols-12 sm:gap-10 intro-y">
                    <div class="col-span-12 sm:col-span-6 md:col-span-4 py-6 sm:pl-5 md:pl-0 lg:pl-5 relative text-center sm:text-left">
                        <div class="absolute pt-0.5 xxl:pt-0 mt-5 xxl:mt-6 top-0 right-0 dropdown">
                            <a class="dropdown-toggle block" href="javascript:;" aria-expanded="false">
                                <i data-feather="more-vertical" class="w-5 h-5 text-theme-35"></i>
                            </a>
                        ...
                        <div class="text-white text-sm xxl:text-base font-medium -mb-1">
                            Hi Angelina, <span class="text-theme-35 dark:text-gray-500 font-normal">welcome back!</span>
                        </div>
                        <div class="text-base xxl:text-lg justify-center sm:justify-start flex items-center text-theme-35 dark:text-gray-500 leading-3 mt-14 xxl:mt-24">
                            My Total Assets
                        ...
                        <div class="xxl:flex mt-5 mb-3">
                            <div class="flex items-center justify-center sm:justify-start">
                                <div class="text-white relative text-2xl xxl:text-3xl font-medium leading-6 pl-3 xxl:pl-4">
                                    <span class="absolute text-xl xxl:text-2xl top-0 left-0 -mt-1 xxl:mt-0">$</span> 18,402,210
                                </div>
                                <a class="text-gray-500 ml-4 xxl:ml-16" href="">
                            ...
                            <div class="mt-5 xxl:flex xxl:justify-center xxl:mt-0 xxl:-ml-20 xxl:w-14 xxl:flex-none xxl:pl-2.5">
                                <div class="font-medium inline-flex bg-theme-20 text-white rounded-full px-2 py-1 text-xs xxl:text-sm xxl:p-0 xxl:text-theme-20 xxl:bg-transparent xxl:flex items-center tooltip cursor-pointer xxl:justify-center" title="49% Higher than last month">
                                    49% <i data-feather="chevron-up" class="w-4 h-4 ml-0.5"></i>
                                </div>
                            </div>
                        </div>
                        <div class="text-theme-35 mt-5">Last updated 1 hour ago</div>
                        <div class="xxl:text-base text-theme-35 mt-6 -mb-1">
                            Total net margin <span class="font-medium">$921,050</span>
                        </div>
                        <div class="mt-14 xxl:mt-24 dropdown">
                            <button class="dropdown-toggle btn btn-rounded bg-theme-25 border-theme-25 text-white w-44 xxl:w-52 px-4 relative justify-start" aria-expanded="false">
                                Download Reports
                    ...
                    <div class="row-start-2 md:row-start-auto col-span-12 md:col-span-4 py-6 border-theme-11 border-t md:border-t-0 md:border-l md:border-r border-dashed px-10 sm:px-28 md:px-5 -mx-5">
                        <div class="flex flex-wrap items-center">
                            <div class="flex items-center w-full sm:w-auto justify-center sm:justify-start mr-auto mb-5 xxl:mb-0">
                                ...
                                <div class="ml-3.5">
                                    <div class="relative text-white text-xl xxl:text-2xl font-medium leading-6 xxl:leading-5 pl-3.5 xxl:pl-4">
                                        <span class="absolute text-base xxl:text-xl top-0 left-0 xxl:-mt-1.5">$</span> 47,578.77
                                    </div>
                                    <div class="text-theme-35 dark:text-gray-600 mt-2">Yearly budget</div>
                                </div>
                            </div>
                    ...
                    <div class="col-span-12 sm:col-span-6 md:col-span-4 py-6 border-theme-11 border-t sm:border-t-0 border-l md:border-l-0 border-dashed -ml-4 pl-4 md:ml-0 md:pl-0">
                        <div class="boxed-tabs nav nav-tabs justify-center w-3/4 xxl:w-4/6 bg-theme-27 text-white dark:bg-dark-2 dark:text-gray-500 rounded-md p-1 mx-auto" role="tablist">
                            ...
                            <div class="tab-pane active" id="active-users" role="tabpanel" aria-labelledby="active-users-tab">
                                <div class="relative">
                                    ...
                                    <div class="flex flex-col justify-center items-center absolute w-full h-full top-0 left-0">
                                        <div class="text-white text-xl xxl:text-2xl font-medium">2.501</div>
                    ...
                    <div class="col-span-12 sm:col-span-4 xl:col-span-3 px-0 lg:px-6 xl:px-0 xxl:px-6">
                        ...
                        <div class="flex items-center justify-center mt-10">
                            <div class="text-right">
                                ...
                                <div class="text-gray-500 truncate mt-1 text-theme-35 dark:text-theme-35">Active Lenders</div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="text-gray-500 truncate mt-1 text-theme-35 dark:text-theme-35">Total Lenders</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-span-12 sm:col-span-4 xl:col-span-3 px-0 lg:px-6 xl:px-0 xxl:px-6">
    ...
    <div class="report-box-3 report-box-3--content grid grid-cols-12 gap-6 xl:-mt-5 xxl:-mt-8 -mb-10 z-40 xxl:z-10">
        ...
        <div class="col-span-12 xxl:col-span-3 relative z-10">
            <div class="xxl:border-l border-theme-31 pb-10 intro-y">
